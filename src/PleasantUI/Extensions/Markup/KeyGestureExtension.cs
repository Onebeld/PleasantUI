...
public class KeyGestureExtension : MarkupExtension
{
	...
	public KeyGestureExtension(string keyGesture) => _keyGesture = keyGesture;
	...
	public override object ProvideValue(IServiceProvider serviceProvider) => KeyGesture.Parse(_keyGesture).ToString();
}