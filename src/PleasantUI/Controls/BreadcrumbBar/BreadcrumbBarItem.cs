...
public class BreadcrumbBarItem : ContentControl
{
    ...
    private const string PART_LastItemContentPresenter = "PART_LastItemContentPresenter";
    private const string PART_ChevronTextBlock = "PART_ChevronTextBlock";
    private const string PART_EllipsisDropDownItemPresenter = "PART_EllipsisDropDownItemPresenter";
    private const string PART_EllipsisFlyoutKey = "PART_EllipsisFlyout";
    ...
    private const string PC_LastItem = ":lastItem";
    private const string PC_EllipsisDropDown = ":ellipsisDropDown";
    private const string PC_AllowClick = ":allowClick";
    ...
    /// <summary>
    /// Gets whether this item is rendered inside the ellipsis drop-down flyout.
    /// </summary>
    ...
    protected override void OnPointerPressed(PointerPressedEventArgs e)
    {
        ...
        _isPressed = e.Pointer.Type != PointerType.Mouse || e.GetCurrentPoint(this).Properties.IsLeftButtonPressed;
    ...
    internal void SetPropertiesForLastItem()
    {
        ...
        _isLastItem = true;
        _allowClickOnLastItem = _parentBreadcrumb?.TryGetTarget(out BreadcrumbBar? bar) == true && bar.IsLastItemClickEnabled;
        UpdateButtonVisualState();
        UpdateInlineTypeVisualState();
    }
    ...
    private void CloseFlyout() => _ellipsisFlyout?.Hide();
