...
/// The first value in the values list is the translation text, and the remaining values are the arguments to be used in the format string.
/// </summary>
public class TranslateConverter : IMultiValueConverter
{
	...
	/// </summary>
	/// <param name="values">A list of values. The first value is the translation text, and the remaining values are the arguments to be used in the format string.</param>
