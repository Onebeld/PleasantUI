...
public class PleasantNotificationManager : TemplatedControl, IManagedNotificationManager
{
    ...
    public PleasantNotificationManager(IPleasantWindow? host)
    {
        if (host != null)
        {
            Install(host);
    ...
    static PleasantNotificationManager()
    {
    ...
    protected override Type StyleKeyOverride => typeof(WindowNotificationManager);

    /// <inheritdoc/>
    protected override void OnApplyTemplate(TemplateAppliedEventArgs e)
    {
        Panel? itemsControl = e.NameScope.Find<Panel>("PART_Items");
    ...
    public async void Show(object content)
    {
        ...
        NotificationCard notificationControl = new()
        {
            Content = content
        };
        ...
        {
            if (notification is { OnClick: not null })
            {
    ...
    private void Install(IPleasantWindow host)
    {
        AdornerLayer adornerLayer = host.VisualLayerManager.AdornerLayer;
